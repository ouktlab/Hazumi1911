...
実験用ダンプファイルは以下の書誌に掲載された研究で使用されたものに言語特徴量を加えたものです．生体信号特徴量に関して，以下の研究で使われたものの一部を含んでいます．  
```
...
各ファイル（1911F2001.csv）は各セッションにおける参加者の発話対ごとの
マルチモーダル特徴量とアノテーションの値を含んでいる．
データ欠損のある1911F7001, 1911M3001, 1911M3002, 1911M5003に関して， ダンプファイルは存在しない． 計26人分のダンプファイルを格納している．
